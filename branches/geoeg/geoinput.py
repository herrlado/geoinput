...
class geoinput(geoinputbase):
    ...
    def init(self):
        ...
        self.keymap = {
            EKey0 : [" ", "0","\r"],
            EKey1 : [".", ",", "?", "!", "@", "'", "-", "1"],
            EKey2 : ["а", "б", "в", "г", "А", "Б", "В", "Г", "2"],
            EKey3 : ["д", "е", "ж", "з", "Д", "Е", "Ж", "З", "3"],
            EKey4 : ["и", "й", "к", "л", "И", "Й", "К", "Л", "4"],
            EKey5 : ["м", "н", "о", "п", "М", "Н", "О", "П", "5"],
            EKey6 : ["р", "с", "т", "у", "Р", "С", "Т", "У", "6"],
            EKey7 : ["ф", "х", "ц", "ч", "Ф", "Х", "Ц", "Ч", "7"],
            EKey8 : ["ш", "щ", "ъ", "ы", "Ш", "Щ", "Ъ", "Ы", "8"],
            EKey9 : ["ь", "э", "ю", "я", "Ь", "Э", "Ю", "Я", "9"]
            }
