...
MERGED_TARGET=geoinput-121.sis
# create sis-filex
def#ensymble.py py2sis --uid=0xe3e34da2 --appname="geinput" --shortcaption="geoinput" --version=$VERSION --vendor="Lado Kumsiashvili" --verbose build geoinput-${VERSION}.sis
